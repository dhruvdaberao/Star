                            ...
                            {usersToShow.map(user => (
                                <div key={user.id} className="bg-background p-3 rounded-lg flex items-center justify-between">
                                    ...
                                    <button 
                                        ...
                                        className="font-semibold px-4 py-1.5 rounded-lg transition-colors text-sm ml-2 flex-shrink-0 bg-surface text-primary border border-border hover:bg-background"
                                    >
                                        Unblock
                                    </button>
                                </div>
